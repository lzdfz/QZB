...
#ifndef FQ__MSG__DETAIL__ACTOR_AIRPLANE__STRUCT_HPP_
#define FQ__MSG__DETAIL__ACTOR_AIRPLANE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__fq__msg__ActorAirplane __attribute__((deprecated))
#else
# define DEPRECATED__fq__msg__ActorAirplane __declspec(deprecated)
#endif
...
struct ActorAirplane_
{
  using Type = ActorAirplane_<ContainerAllocator>;

  explicit ActorAirplane_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : base_data(_init),
    attributes(_init),
  ...
  explicit ActorAirplane_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    fq::msg::ActorAirplane_<ContainerAllocator> *;
  using ConstRawPtr =
    const fq::msg::ActorAirplane_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<fq::msg::ActorAirplane_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<fq::msg::ActorAirplane_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      fq::msg::ActorAirplane_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<fq::msg::ActorAirplane_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<fq::msg::ActorAirplane_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<fq::msg::ActorAirplane_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<fq::msg::ActorAirplane_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__fq__msg__ActorAirplane
    std::shared_ptr<fq::msg::ActorAirplane_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__fq__msg__ActorAirplane
    std::shared_ptr<fq::msg::ActorAirplane_<ContainerAllocator> const>
  ...
  bool operator==(const ActorAirplane_ & other) const
  {
...
using ActorAirplane =
  fq::msg::ActorAirplane_<std::allocator<void>>;
...
#endif  // FQ__MSG__DETAIL__ACTOR_AIRPLANE__STRUCT_HPP_
