...
#ifndef FQ__MSG__DETAIL__ACTOR_VEHICLE__STRUCT_HPP_
#define FQ__MSG__DETAIL__ACTOR_VEHICLE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__fq__msg__ActorVehicle __attribute__((deprecated))
#else
# define DEPRECATED__fq__msg__ActorVehicle __declspec(deprecated)
#endif
...
struct ActorVehicle_
{
  using Type = ActorVehicle_<ContainerAllocator>;

  explicit ActorVehicle_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : base_data(_init),
  ...
  explicit ActorVehicle_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    fq::msg::ActorVehicle_<ContainerAllocator> *;
  using ConstRawPtr =
    const fq::msg::ActorVehicle_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<fq::msg::ActorVehicle_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<fq::msg::ActorVehicle_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      fq::msg::ActorVehicle_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<fq::msg::ActorVehicle_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<fq::msg::ActorVehicle_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<fq::msg::ActorVehicle_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<fq::msg::ActorVehicle_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__fq__msg__ActorVehicle
    std::shared_ptr<fq::msg::ActorVehicle_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__fq__msg__ActorVehicle
    std::shared_ptr<fq::msg::ActorVehicle_<ContainerAllocator> const>
  ...
  bool operator==(const ActorVehicle_ & other) const
  {
...
using ActorVehicle =
  fq::msg::ActorVehicle_<std::allocator<void>>;
...
#endif  // FQ__MSG__DETAIL__ACTOR_VEHICLE__STRUCT_HPP_
