...
#ifndef FQ__MSG__DETAIL__ACTOR_HUMAN__STRUCT_HPP_
#define FQ__MSG__DETAIL__ACTOR_HUMAN__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__fq__msg__ActorHuman __attribute__((deprecated))
#else
# define DEPRECATED__fq__msg__ActorHuman __declspec(deprecated)
#endif
...
struct ActorHuman_
{
  using Type = ActorHuman_<ContainerAllocator>;

  explicit ActorHuman_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : base_data(_init),
  ...
  explicit ActorHuman_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    fq::msg::ActorHuman_<ContainerAllocator> *;
  using ConstRawPtr =
    const fq::msg::ActorHuman_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<fq::msg::ActorHuman_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<fq::msg::ActorHuman_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      fq::msg::ActorHuman_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<fq::msg::ActorHuman_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<fq::msg::ActorHuman_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<fq::msg::ActorHuman_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<fq::msg::ActorHuman_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__fq__msg__ActorHuman
    std::shared_ptr<fq::msg::ActorHuman_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__fq__msg__ActorHuman
    std::shared_ptr<fq::msg::ActorHuman_<ContainerAllocator> const>
  ...
  bool operator==(const ActorHuman_ & other) const
  {
...
using ActorHuman =
  fq::msg::ActorHuman_<std::allocator<void>>;
...
#endif  // FQ__MSG__DETAIL__ACTOR_HUMAN__STRUCT_HPP_
