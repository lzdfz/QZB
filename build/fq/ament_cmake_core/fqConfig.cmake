...
if(_fq_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED fq_FOUND)
...
set(_fq_CONFIG_INCLUDED TRUE)

# output package information
if(NOT fq_FIND_QUIETLY)
  message(STATUS "Found fq: 2.0.0 (${fq_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'fq' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${fq_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(fq_FOUND_AMENT_PACKAGE TRUE)
