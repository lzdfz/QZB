...
bool fq__msg__actor_airplane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._actor_airplane.ActorAirplane", full_classname_dest, 36) == 0);
  }
  fq__msg__ActorAirplane * ros_message = _ros_message;
  {  // base_data
...
{
  /* NOTE(esteve): Call constructor of ActorAirplane */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._actor_airplane");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActorAirplane");
