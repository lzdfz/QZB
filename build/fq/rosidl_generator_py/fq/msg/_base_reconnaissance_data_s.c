...
bool fq__msg__base_reconnaissance_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._base_reconnaissance_data.BaseReconnaissanceData", full_classname_dest, 55) == 0);
  }
  fq__msg__BaseReconnaissanceData * ros_message = _ros_message;
  {  // targets
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->targets.data;
...
{
  /* NOTE(esteve): Call constructor of BaseReconnaissanceData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._base_reconnaissance_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseReconnaissanceData");
  ...
  {  // targets
    ...
    if (ros_message->targets.size > 0) {
      ...
      int32_t * src = &(ros_message->targets.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->targets.size * sizeof(int32_t));
      assert(data != NULL);
