...
bool fq__msg__base_kinematics_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._base_kinematics_data.BaseKinematicsData", full_classname_dest, 47) == 0);
  }
  fq__msg__BaseKinematicsData * ros_message = _ros_message;
  {  // location
...
{
  /* NOTE(esteve): Call constructor of BaseKinematicsData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._base_kinematics_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseKinematicsData");
