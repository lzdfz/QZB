...
bool fq__msg__base_zone_attr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._base_zone_attr.BaseZoneAttr", full_classname_dest, 35) == 0);
  }
  fq__msg__BaseZoneAttr * ros_message = _ros_message;
  {  // height
...
{
  /* NOTE(esteve): Call constructor of BaseZoneAttr */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._base_zone_attr");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseZoneAttr");
