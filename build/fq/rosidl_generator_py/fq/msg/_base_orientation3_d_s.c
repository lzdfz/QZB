...
bool fq__msg__base_orientation3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._base_orientation3_d.BaseOrientation3D", full_classname_dest, 45) == 0);
  }
  fq__msg__BaseOrientation3D * ros_message = _ros_message;
  {  // roll
...
{
  /* NOTE(esteve): Call constructor of BaseOrientation3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._base_orientation3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseOrientation3D");
