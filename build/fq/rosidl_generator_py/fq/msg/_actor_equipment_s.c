...
bool fq__msg__actor_equipment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._actor_equipment.ActorEquipment", full_classname_dest, 38) == 0);
  }
  fq__msg__ActorEquipment * ros_message = _ros_message;
  {  // base_data
...
{
  /* NOTE(esteve): Call constructor of ActorEquipment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._actor_equipment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActorEquipment");
