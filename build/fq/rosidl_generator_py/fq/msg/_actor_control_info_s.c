...
bool fq__msg__actor_control_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._actor_control_info.ActorControlInfo", full_classname_dest, 43) == 0);
  }
  fq__msg__ActorControlInfo * ros_message = _ros_message;
  {  // id
  ...
  {  // target_headings
    PyObject * field = PyObject_GetAttrString(_pymsg, "target_headings");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->target_headings.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'target_headings'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ActorControlInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._actor_control_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActorControlInfo");
  ...
  {  // target_headings
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "target_headings");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->target_headings.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->target_headings.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->target_headings.size * sizeof(float));
      assert(data != NULL);
