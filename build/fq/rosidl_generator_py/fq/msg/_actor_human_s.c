...
bool fq__msg__actor_human__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._actor_human.ActorHuman", full_classname_dest, 30) == 0);
  }
  fq__msg__ActorHuman * ros_message = _ros_message;
  {  // base_data
...
{
  /* NOTE(esteve): Call constructor of ActorHuman */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._actor_human");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActorHuman");
