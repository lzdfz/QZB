...
bool fq__msg__base_bytes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._base_bytes.BaseBytes", full_classname_dest, 28) == 0);
  }
  fq__msg__BaseBytes * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of BaseBytes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._base_bytes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseBytes");
