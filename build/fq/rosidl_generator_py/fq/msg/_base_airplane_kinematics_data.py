...
class Metaclass_BaseAirplaneKinematicsData(type):
    """Metaclass of message 'BaseAirplaneKinematicsData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__base_airplane_kinematics_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__base_airplane_kinematics_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__base_airplane_kinematics_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__base_airplane_kinematics_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__base_airplane_kinematics_data
...
class BaseAirplaneKinematicsData(metaclass=Metaclass_BaseAirplaneKinematicsData):
    """Message class 'BaseAirplaneKinematicsData'."""
