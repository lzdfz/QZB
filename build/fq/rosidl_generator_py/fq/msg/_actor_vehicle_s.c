...
bool fq__msg__actor_vehicle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._actor_vehicle.ActorVehicle", full_classname_dest, 34) == 0);
  }
  fq__msg__ActorVehicle * ros_message = _ros_message;
  {  // base_data
...
{
  /* NOTE(esteve): Call constructor of ActorVehicle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._actor_vehicle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActorVehicle");
