...
bool fq__msg__base_be_interference_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._base_be_interference_data.BaseBeInterferenceData", full_classname_dest, 56) == 0);
  }
  fq__msg__BaseBeInterferenceData * ros_message = _ros_message;
  {  // percent
...
{
  /* NOTE(esteve): Call constructor of BaseBeInterferenceData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._base_be_interference_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseBeInterferenceData");
