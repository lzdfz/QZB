...
bool fq__msg__actor_building__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fq.msg._actor_building.ActorBuilding", full_classname_dest, 36) == 0);
  }
  fq__msg__ActorBuilding * ros_message = _ros_message;
  {  // base_data
  ...
  {  // damage_condition_data
    PyObject * field = PyObject_GetAttrString(_pymsg, "damage_condition_data");
    if (!field) {
      return false;
    }
    if (!fq__msg__base_damage_condition_data__convert_from_py(field, &ros_message->damage_condition_data)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ActorBuilding */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fq.msg._actor_building");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActorBuilding");
  ...
  {  // damage_condition_data
    PyObject * field = NULL;
    field = fq__msg__base_damage_condition_data__convert_to_py(&ros_message->damage_condition_data);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "damage_condition_data", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
