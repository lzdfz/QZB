...
static const _ActorDroneSwarms_type_support_symbol_names_t _ActorDroneSwarms_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, ActorDroneSwarms)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fq, msg, ActorDroneSwarms)),
  }
};
...
{
  return &::fq::msg::rosidl_typesupport_cpp::ActorDroneSwarms_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fq, msg, ActorDroneSwarms)() {
  return get_message_type_support_handle<fq::msg::ActorDroneSwarms>();
}
