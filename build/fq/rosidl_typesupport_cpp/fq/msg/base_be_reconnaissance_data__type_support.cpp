...
static const _BaseBeReconnaissanceData_type_support_symbol_names_t _BaseBeReconnaissanceData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, BaseBeReconnaissanceData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fq, msg, BaseBeReconnaissanceData)),
  }
};
...
{
  return &::fq::msg::rosidl_typesupport_cpp::BaseBeReconnaissanceData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fq, msg, BaseBeReconnaissanceData)() {
  return get_message_type_support_handle<fq::msg::BaseBeReconnaissanceData>();
}
