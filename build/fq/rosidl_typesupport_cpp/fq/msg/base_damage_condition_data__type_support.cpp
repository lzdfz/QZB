...
static const _BaseDamageConditionData_type_support_symbol_names_t _BaseDamageConditionData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, BaseDamageConditionData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fq, msg, BaseDamageConditionData)),
  }
};
...
{
  return &::fq::msg::rosidl_typesupport_cpp::BaseDamageConditionData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fq, msg, BaseDamageConditionData)() {
  return get_message_type_support_handle<fq::msg::BaseDamageConditionData>();
}
