...
#include "fq/msg/detail/base_reconnaissance_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fq::msg::BaseReconnaissanceData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fq::msg::BaseReconnaissanceData & ros_message)
{
  // Member: targets
  {
    cdr >> ros_message.targets;
...
{
  auto typed_message =
    static_cast<const fq::msg::BaseReconnaissanceData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fq::msg::BaseReconnaissanceData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BaseReconnaissanceData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fq::msg::BaseReconnaissanceData *>(
...
{
  return max_serialized_size_BaseReconnaissanceData(full_bounded, 0);
}

static message_type_support_callbacks_t _BaseReconnaissanceData__callbacks = {
  "fq::msg",
...
static rosidl_message_type_support_t _BaseReconnaissanceData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BaseReconnaissanceData__callbacks,
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_BaseReconnaissanceData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, BaseReconnaissanceData)() {
  return &fq::msg::typesupport_fastrtps_cpp::_BaseReconnaissanceData__handle;
}
