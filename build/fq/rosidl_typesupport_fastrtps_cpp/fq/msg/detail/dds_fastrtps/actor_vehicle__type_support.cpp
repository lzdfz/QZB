...
#include "fq/msg/detail/actor_vehicle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fq::msg::ActorVehicle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fq::msg::ActorVehicle & ros_message)
{
  // Member: base_data
...
{
  auto typed_message =
    static_cast<const fq::msg::ActorVehicle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fq::msg::ActorVehicle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ActorVehicle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fq::msg::ActorVehicle *>(
...
{
  return max_serialized_size_ActorVehicle(full_bounded, 0);
}

static message_type_support_callbacks_t _ActorVehicle__callbacks = {
  "fq::msg",
  "ActorVehicle",
...
static rosidl_message_type_support_t _ActorVehicle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ActorVehicle__callbacks,
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_ActorVehicle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, ActorVehicle)() {
  return &fq::msg::typesupport_fastrtps_cpp::_ActorVehicle__handle;
}
