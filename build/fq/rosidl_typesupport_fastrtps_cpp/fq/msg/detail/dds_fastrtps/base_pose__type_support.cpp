...
#include "fq/msg/detail/base_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fq::msg::BasePose & ros_message,
...
{
  auto typed_message =
    static_cast<const fq::msg::BasePose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fq::msg::BasePose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BasePose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fq::msg::BasePose *>(
...
{
  return max_serialized_size_BasePose(full_bounded, 0);
}

static message_type_support_callbacks_t _BasePose__callbacks = {
  "fq::msg",
  "BasePose",
...
static rosidl_message_type_support_t _BasePose__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BasePose__callbacks,
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_BasePose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, BasePose)() {
  return &fq::msg::typesupport_fastrtps_cpp::_BasePose__handle;
}
