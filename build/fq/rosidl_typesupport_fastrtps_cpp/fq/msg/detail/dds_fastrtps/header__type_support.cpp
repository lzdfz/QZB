...
#include "fq/msg/detail/header__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const fq::msg::Header *>(
    untyped_ros_message);
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_Header__handle;
}
