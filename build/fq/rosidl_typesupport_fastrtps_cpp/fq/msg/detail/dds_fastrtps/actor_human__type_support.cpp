...
#include "fq/msg/detail/actor_human__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fq::msg::ActorHuman & ros_message,
...
{
  auto typed_message =
    static_cast<const fq::msg::ActorHuman *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fq::msg::ActorHuman *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ActorHuman__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fq::msg::ActorHuman *>(
...
{
  return max_serialized_size_ActorHuman(full_bounded, 0);
}

static message_type_support_callbacks_t _ActorHuman__callbacks = {
  "fq::msg",
  "ActorHuman",
...
static rosidl_message_type_support_t _ActorHuman__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ActorHuman__callbacks,
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_ActorHuman__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, ActorHuman)() {
  return &fq::msg::typesupport_fastrtps_cpp::_ActorHuman__handle;
}
