...
#include "fq/msg/detail/actor_airplane__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const fq::msg::ActorAirplane *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fq::msg::ActorAirplane *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ActorAirplane__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fq::msg::ActorAirplane *>(
...
{
  return max_serialized_size_ActorAirplane(full_bounded, 0);
}

static message_type_support_callbacks_t _ActorAirplane__callbacks = {
  "fq::msg",
  "ActorAirplane",
...
static rosidl_message_type_support_t _ActorAirplane__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ActorAirplane__callbacks,
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_ActorAirplane__handle;
}
