...
#include "fq/msg/detail/actor_warship__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fq::msg::ActorWarship & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fq::msg::ActorWarship & ros_message)
{
  // Member: base_data
...
{
  auto typed_message =
    static_cast<const fq::msg::ActorWarship *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fq::msg::ActorWarship *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ActorWarship__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fq::msg::ActorWarship *>(
...
{
  return max_serialized_size_ActorWarship(full_bounded, 0);
}

static message_type_support_callbacks_t _ActorWarship__callbacks = {
  "fq::msg",
  "ActorWarship",
...
static rosidl_message_type_support_t _ActorWarship__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ActorWarship__callbacks,
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_ActorWarship__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, ActorWarship)() {
  return &fq::msg::typesupport_fastrtps_cpp::_ActorWarship__handle;
}
