...
#include "fq/msg/detail/base_kinematics_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fq::msg::BaseKinematicsData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fq::msg::BaseKinematicsData & ros_message)
{
  // Member: location
...
{
  auto typed_message =
    static_cast<const fq::msg::BaseKinematicsData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fq::msg::BaseKinematicsData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BaseKinematicsData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fq::msg::BaseKinematicsData *>(
...
{
  return max_serialized_size_BaseKinematicsData(full_bounded, 0);
}

static message_type_support_callbacks_t _BaseKinematicsData__callbacks = {
  "fq::msg",
  "BaseKinematicsData",
...
static rosidl_message_type_support_t _BaseKinematicsData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BaseKinematicsData__callbacks,
...
{
  return &fq::msg::typesupport_fastrtps_cpp::_BaseKinematicsData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fq, msg, BaseKinematicsData)() {
  return &fq::msg::typesupport_fastrtps_cpp::_BaseKinematicsData__handle;
}
