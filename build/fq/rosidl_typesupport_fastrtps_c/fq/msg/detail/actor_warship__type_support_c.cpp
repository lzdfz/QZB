...
#include "fq/msg/detail/actor_warship__rosidl_typesupport_fastrtps_c.h"
...
using _ActorWarship__ros_msg_type = fq__msg__ActorWarship;

static bool _ActorWarship__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ActorWarship__ros_msg_type * ros_message = static_cast<const _ActorWarship__ros_msg_type *>(untyped_ros_message);
...
static bool _ActorWarship__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ActorWarship__ros_msg_type * ros_message = static_cast<_ActorWarship__ros_msg_type *>(untyped_ros_message);
  // Field name: base_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ActorWarship__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fq__msg__ActorWarship(
...
static size_t _ActorWarship__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_fq__msg__ActorWarship(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ActorWarship = {
  "fq::msg",
  "ActorWarship",
  _ActorWarship__cdr_serialize,
  _ActorWarship__cdr_deserialize,
  _ActorWarship__get_serialized_size,
  _ActorWarship__max_serialized_size
};

static rosidl_message_type_support_t _ActorWarship__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ActorWarship,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fq, msg, ActorWarship)() {
  return &_ActorWarship__type_support;
}
