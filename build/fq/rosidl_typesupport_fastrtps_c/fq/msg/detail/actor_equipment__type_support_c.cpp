...
#include "fq/msg/detail/actor_equipment__rosidl_typesupport_fastrtps_c.h"
...
using _ActorEquipment__ros_msg_type = fq__msg__ActorEquipment;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ActorEquipment__ros_msg_type * ros_message = static_cast<const _ActorEquipment__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _ActorEquipment__ros_msg_type * ros_message = static_cast<_ActorEquipment__ros_msg_type *>(untyped_ros_message);
  // Field name: base_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ActorEquipment__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fq__msg__ActorEquipment(
...
{
  return max_serialized_size_fq__msg__ActorEquipment(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ActorEquipment = {
  "fq::msg",
  "ActorEquipment",
...
static rosidl_message_type_support_t _ActorEquipment__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ActorEquipment,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fq, msg, ActorEquipment)() {
  return &_ActorEquipment__type_support;
}
