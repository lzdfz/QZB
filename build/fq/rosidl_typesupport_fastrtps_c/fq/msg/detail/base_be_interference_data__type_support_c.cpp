...
#include "fq/msg/detail/base_be_interference_data__rosidl_typesupport_fastrtps_c.h"
...
using _BaseBeInterferenceData__ros_msg_type = fq__msg__BaseBeInterferenceData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BaseBeInterferenceData__ros_msg_type * ros_message = static_cast<const _BaseBeInterferenceData__ros_msg_type *>(untyped_ros_message);
  // Field name: percent
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BaseBeInterferenceData__ros_msg_type * ros_message = static_cast<_BaseBeInterferenceData__ros_msg_type *>(untyped_ros_message);
  // Field name: percent
  {
    cdr >> ros_message->percent;
  }
...
static uint32_t _BaseBeInterferenceData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fq__msg__BaseBeInterferenceData(
...
{
  return max_serialized_size_fq__msg__BaseBeInterferenceData(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_BaseBeInterferenceData = {
  "fq::msg",
...
static rosidl_message_type_support_t _BaseBeInterferenceData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BaseBeInterferenceData,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fq, msg, BaseBeInterferenceData)() {
  return &_BaseBeInterferenceData__type_support;
}
