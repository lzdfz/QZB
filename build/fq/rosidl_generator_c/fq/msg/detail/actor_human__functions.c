...
fq__msg__ActorHuman__create()
{
  ...
  fq__msg__ActorHuman * msg = (fq__msg__ActorHuman *)allocator.allocate(sizeof(fq__msg__ActorHuman), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fq__msg__ActorHuman));
  bool success = fq__msg__ActorHuman__init(msg);
  if (!success) {
...
fq__msg__ActorHuman__Sequence__init(fq__msg__ActorHuman__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fq__msg__ActorHuman * data = NULL;

  if (size) {
    data = (fq__msg__ActorHuman *)allocator.zero_allocate(size, sizeof(fq__msg__ActorHuman), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fq__msg__ActorHuman__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        fq__msg__ActorHuman__fini(&data[i - 1]);
      }
...
fq__msg__ActorHuman__Sequence__fini(fq__msg__ActorHuman__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      fq__msg__ActorHuman__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fq__msg__ActorHuman__Sequence * array = (fq__msg__ActorHuman__Sequence *)allocator.allocate(sizeof(fq__msg__ActorHuman__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fq__msg__ActorHuman__Sequence__init(array, size);
  if (!success) {
...
fq__msg__ActorHuman__Sequence__destroy(fq__msg__ActorHuman__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fq__msg__ActorHuman__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fq__msg__ActorHuman__Sequence__are_equal(const fq__msg__ActorHuman__Sequence * lhs, const fq__msg__ActorHuman__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fq__msg__ActorHuman__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fq__msg__ActorHuman__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fq__msg__ActorHuman);
    fq__msg__ActorHuman * data =
      (fq__msg__ActorHuman *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fq__msg__ActorHuman__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          fq__msg__ActorHuman__fini(&data[i]);
        }
        free(data);
        return false;
      }
